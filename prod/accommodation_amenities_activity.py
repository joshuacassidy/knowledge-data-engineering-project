...
SELECT DISTINCT ?amenities ?activity ?activityLocation ?accomodationId {
...
def accommodation_amenities_activity():
    ...
    competency_question_title = "Competency Question 4: Accommodation Amenities Activity"
    competency_question = """What are the amenities offered in accomodations for someone that wishes to visit Golf activity?"""
    results_set_vars = ["Activity Location", "Property Type", "Activity Location", "Accomodation Id" ]
